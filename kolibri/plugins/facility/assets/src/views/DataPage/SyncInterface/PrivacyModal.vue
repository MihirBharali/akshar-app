...
<script>
  ...
  export default {
    ...
    $trs: {
      ...
      privacyText: {
        message:
          'By syncing this facility with the Akshar Data Portal, you are granting access to your data to organization admins on Kolibri Data Portal. It will be uploaded to cloud servers operated by Learning Equality, who will also have access to this data.',
        context:
